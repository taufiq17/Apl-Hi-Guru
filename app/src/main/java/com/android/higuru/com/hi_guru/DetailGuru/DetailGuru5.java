...
import com.android.higuru.com.hi_guru.Pemesanan.Pemesanan5;
import com.android.higuru.com.hi_guru.R;

public class DetailGuru5 extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detailguru5);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent i = new Intent(DetailGuru5.this, AboutUs.class);
            startActivity(i);

            return true;
        }
        else if(id == R.id.action_logout){
            Intent i = new Intent(DetailGuru5.this,LoginActivity.class);
            startActivity(i);
            return true;
        }
    ...
    public void pemesanan (View view) {
        Intent i = new Intent(DetailGuru5.this, Pemesanan5.class);
        startActivity(i);
    }
