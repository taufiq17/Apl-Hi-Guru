...
public class Pemesanan5 extends AppCompatActivity{
    Button btnPilih;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pemesanan5);
        ...
        btnPilih.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick (View v) {
                ...
                CharSequence text = "Selamat !!! Pemesanan telah berhasil. " +
                        "Anda memilih Dicky Anggriawan, S. Kom sebagai guru les";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent i = new Intent(Pemesanan5.this, AboutUs.class);
            startActivity(i);

            return true;
        }
        else if(id == R.id.action_logout){
            Intent i = new Intent(Pemesanan5.this,LoginActivity.class);
            startActivity(i);
            return true;
        }
