...
public class Pemesanan3 extends AppCompatActivity{
        ...
        btnPilih.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick (View v) {
                ...
                CharSequence text = "Selamat !!! Pemesanan telah berhasil. " +
                        "Anda memilih Alfian Chandra, S. Kom sebagai guru les";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent i = new Intent(Pemesanan3.this, AboutUs.class);
            startActivity(i);

            return true;
        }
        else if(id == R.id.action_logout){
            Intent i = new Intent(Pemesanan3.this,LoginActivity.class);
            startActivity(i);
            return true;
        }
