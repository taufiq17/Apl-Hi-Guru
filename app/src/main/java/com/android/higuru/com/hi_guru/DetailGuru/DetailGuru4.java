...
import com.android.higuru.com.hi_guru.Pemesanan.Pemesanan4;
import com.android.higuru.com.hi_guru.R;

public class DetailGuru4 extends AppCompatActivity {


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detailguru4);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent i = new Intent(DetailGuru4.this, AboutUs.class);
            startActivity(i);

            return true;
        }
        else if(id == R.id.action_logout){
            Intent i = new Intent(DetailGuru4.this,LoginActivity.class);
            startActivity(i);
            return true;
        }
    ...
    public void pemesanan (View view) {
        Intent i = new Intent(DetailGuru4.this, Pemesanan4.class);
        startActivity(i);
    }
