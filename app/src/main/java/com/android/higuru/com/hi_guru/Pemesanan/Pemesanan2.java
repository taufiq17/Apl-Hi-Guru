...
public class Pemesanan2 extends AppCompatActivity{
        ...
        btnPilih.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick (View v) {
                ...
                CharSequence text = "Selamat !!! Pemesanan telah berhasil. " +
                        "Anda memilih M. Rizaluddin, M. Kom sebagai guru les";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent i = new Intent(Pemesanan2.this, AboutUs.class);
            startActivity(i);

            return true;
        }
        else if(id == R.id.action_logout){
            Intent i = new Intent(Pemesanan2.this,LoginActivity.class);
            startActivity(i);
            return true;
        }
